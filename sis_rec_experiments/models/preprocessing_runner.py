...
def main():
    ...
    results_raw = pipeline_raw.run_experiment(dataset_name="movielens", model_name="baseline")

    print("\n2. PREPROCESSED EXPERIMENT (Cold Start Filtered)")
    print("-" * 50)
    pipeline_filtered = ModelPipeline(
        apply_preprocessing=True,
        preprocessing_params={"min_user_ratings": 20, "min_item_ratings": 10, "max_user_ratings": 500},
    )
    results_filtered = pipeline_filtered.run_experiment(dataset_name="movielens", model_name="baseline")
